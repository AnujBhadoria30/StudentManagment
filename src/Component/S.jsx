...
function S() {
    ...
    const handleSave = () => {
      ...
      if (students.some(student => student.name === name && student.gender === gender && student.password === password && student.studentClass === studentClass)) {
          // Update existing student
          const updatedStudents = students.map((student) =>
              student.name === name && student.gender === gender && student.password === password && student.studentClass === studentClass
                  ? newStudent
                  : student
          );
          ...
          incrementStudentCount(); // Increment count only for new students
      }
